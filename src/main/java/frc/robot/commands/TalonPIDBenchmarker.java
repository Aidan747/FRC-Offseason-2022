...
public class TalonPIDBenchmarker extends CommandBase {
  ...
  public TalonPIDBenchmarker(PIDTunerTalon tuner, WPI_TalonFX to_tune, SimpleWidget bench_reporter, NetworkTableEntry time) {
    this.tuner = tuner;
  ...
  public void end(boolean interrupted) {
    time.setNumber((time_to - (counter * 20)) / 1000);
